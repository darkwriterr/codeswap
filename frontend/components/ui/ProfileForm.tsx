...
export default function ProfileForm() {
    ...
    return (
        <View style={{
            ...
            <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 20, marginBottom: 4, alignSelf: 'center' }}>Set up your learning profile</Text>
            <Text style={{ color: '#b0b5c9', textAlign: 'center', marginBottom: 16 }}>Let others know what you can teach and what you want to learn</Text>
            ...
            <TouchableOpacity
                ...
                <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 17 }}>Continue to Dashboard</Text>
            </TouchableOpacity>
            <TouchableOpacity
                style={{
                    borderColor: '#405be4',
                ...
                <Text style={{ color: '#405be4', fontWeight: 'bold', fontSize: 17 }}>Save & Finish Later</Text>
            </TouchableOpacity>
        </View>
    );
}
